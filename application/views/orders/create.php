      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              ...
              <!-- <input type="hidden" name="service_charge_rate" value="<?php echo $company_data['service_charge_value'] ?>" autocomplete="on">
                <input type="hidden" name="vat_charge_rate" value="<?php echo $company_data['vat_charge_value'] ?>" autocomplete="off"> -->

                <input type="hidden" name="service_charge_rate" value="heelo" autocomplete="on">
                <input type="hidden" name="vat_charge_rate" value="hello" autocomplete="off">
