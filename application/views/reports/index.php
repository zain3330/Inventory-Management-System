  ...
  <section class="content">
    ...
    <div style="display:flex" >
        <div class="form-group " >
          <label style="font-size:15px;" for="gross_amount" class="col-sm-12 control-label"> Date From :</label>
          <input style=" padding: 2px 5px;border-radius: 6px;" type="datetime-local" id="order_date"
            name="orderdatetime" required />
        </div>
        <div class="form-group " style="">
          <label style="font-size:15px;" for="gross_amount" class="col-sm-12 control-label">To:</label>
          <input style=" padding: 2px 5px;border-radius: 6px;" type="datetime-local" id="order_date"
            name="orderdatetime" required />
        </div>
        </div>
