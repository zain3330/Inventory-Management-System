  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <button class="btn btn-primary" id="trigger" data-toggle="modal" data-target="#addModal">Add Raw
          Material</button>
        <br /> <br />
        <?php //endif; ?>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="attribute_quantity">Quantity</label>
            <input type="number" class="form-control" id="attribute_quantity" name="attribute_quantity"
              placeholder="Enter Material Quantity" autocomplete="off">
          </div>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_attribute_price">Material Price</label>
            <input type="number" class="form-control" id="edit_attribute_price" name="edit_attribute_price"
              placeholder="Enter material price" autocomplete="off">
          </div>

          <div class="form-group">
            <label for="attribute_quantity">Quantity</label>
            <input type="number" class="form-control" id="edit_attribute_quantity" name="edit_attribute_quantity"
              placeholder="Enter Material Quantity" autocomplete="off">
          </div>
  ...
  function editFunc(id) {
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#edit_attribute_price").val(response.price);
        $("#edit_attribute_quantity").val(response.quantity);
    ...
    if ($('#edit_category option').length === 0) {
      $.ajax({
        ...
        success: function (response) {
          ...
          response.forEach((res) => {
            $("#edit_category").append(`<option value=${res.id}>${res.name}</option>`)
          })
        }
      })
    }
